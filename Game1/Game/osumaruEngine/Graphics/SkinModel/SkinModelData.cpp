...
//	{
//		D3DXMatrixMultiply(&pFrame->CombinedTransformationMatrix, &pFrame->CombinedTransformationMatrix, pParentMatrix);
//	}
//	else
//	{
...
//			delete[] g_pBoneMatruces;
//			g_pBoneMatruces = new D3DXMATRIXA16[g_NumBoneMatricesMax];
//			if (g_pBoneMatruces == NULL)
//			{
//				hr = E_OUTOFMEMORY;
//				goto e_Exit;
//			}
